...
public class ProducerLowerCase implements Runnable{
    private List<String> dictionary;
    private List<String> listOfPasswords;
    private List<String> listOfCrackedPasswords;

    public ProducerLowerCase(List<String> dictionary, List<String> listOfPasswords, List<String> listOfCrackedPasswords) {
    ...
    public void run() {
        while(true) {
            ...
            for(String word : dictionary){
                String wordToHash = word.toLowerCase();
